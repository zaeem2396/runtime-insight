...
If your change affects configuration, events, webhooks, or root cause analysis, reviewers will expect updates to **USAGE.md** at minimum, and usually a line in **CHANGELOG.md** under `[Unreleased]` (merged into the next version at release time).
